...
import { Users, Zap, Check, X, RefreshCw, Trophy, Copy, Shield } from 'lucide-react';
    ...
    return (
      <div className="flex flex-col min-h-screen justify-between p-6 max-w-lg mx-auto text-center animate-fade-slide-up">
        ...
        <div className="space-y-6">
          <p className="text-[var(--color-aubergine)] font-extrabold uppercase tracking-widest text-xs">
          ...
          <p className="theme-text-secondary text-sm max-w-md mx-auto">
            Share the invite code or url with your team on MS Teams to get started. Up to 30 players can join.
          </p>
          ...
          <div className="p-6 theme-bg-surface border-2 theme-border rounded-3xl shadow-md inline-block w-full">
            ...
            <div className="flex flex-col gap-2 sm:flex-row justify-center">
              ...
              >
                {copied ? <Check className="w-4 h-4 text-[var(--color-green)]" /> : <Copy className="w-4 h-4" />}
        ...
        <div className="text-xs theme-text-secondary flex items-center justify-center gap-2">
          ...
          <span>Peer-to-peer secure session autority running in browser</span>
        </div>
      </div>
    );
  }
      ...
      <header className="sticky top-0 z-10 px-4 py-3 border-b theme-border theme-bg-surface flex items-center justify-between shadow-sm">
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:flex items-center gap-1 text-xs font-semibold theme-text-secondary">
            ...
            <span className="font-mono-jetbrains font-bold text-[var(--color-blue)]">{inviteCode}</span>
          </div>
          <button
            onClick={handleCopyLink}
          ...
          <div className="flex items-center gap-1 text-xs font-semibold theme-text-secondary bg-[var(--bg-primary)] px-2 py-1 rounded-full border theme-border">
            ...
            <span>{participants.length}/30</span>
          </div>
        </div>
      </header>
              ...
              {participants.map((p, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      {isCurrentlyBuzzed && (
                        <span className="text-[var(--color-yellow)] animate-bounce">
                          <Zap className="w-4 h-4 fill-current" />
                        </span>
                      )}
          ...
          <div className="theme-bg-surface border theme-border rounded-2xl p-6 shadow-sm flex-1 flex flex-col justify-between min-h-[320px]">
            ...
            <div className="text-center md:text-left">
              ...
              <div className="flex items-center justify-center md:justify-start gap-2">
                <div className={`w-2.5 h-2.5 rounded-full ${isBuzzerActive ? 'bg-[var(--color-green)] animate-ping' : ''} ${isSomeoneBuzzed ? 'bg-[var(--color-red)]' : 'bg-[var(--color-yellow)]'}`} />
            ...
            <div className="my-8 text-center flex flex-col items-center justify-center flex-1">
              {sessionState.status === 'waiting' && (
                <div className="space-y-4">
                  <div className="w-16 h-16 rounded-full bg-yellow-500/10 text-[var(--color-yellow)] flex items-center justify-center mx-auto">
              ...
              {isBuzzerActive && (
                <div className="space-y-4">
                  <div className="w-20 h-20 rounded-full bg-emerald-500/10 text-[var(--color-green)] flex items-center justify-center mx-auto animate-pulse">
              ...
              {isSomeoneBuzzed && buzzedWinner && (
                <div className="space-y-6 w-full max-w-md animate-spring-bounce">
                  <p className="text-[var(--color-yellow)] font-bold text-xs uppercase tracking-widest">
            ...
            <div className="border-t theme-border pt-4 flex items-center justify-between">
              ...
              <button
                ...
                className="bg-red-500/10 hover:bg-red-500 text-red-500 hover:text-white border border-red-500/20 text-xs font-extrabold px-4 py-2.5 rounded-xl transition flex items-center gap-1.5 cursor-pointer"
              >
